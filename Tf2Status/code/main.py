...
def GetWstr(TimeOut: int = 20, Address: tuple = ("79.127.217.197", 22912), retries=0):
    try:
        ...
        if timemode == 0:
            ...
            next_half_hour = (now + datetime.timedelta(minutes=30 - now.minute % 30)).replace(second=0, microsecond=0)
